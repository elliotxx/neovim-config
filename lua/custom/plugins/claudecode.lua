...
return {
  ...
  -- Claude Code integration for Neovim
  {
    ...
    keys = function()
      ...
      local providers = {
        { key = 'c1', name = 'Claude Official', file = 'ClaudeOfficial.json' },
        { key = 'c2', name = 'Kimi-K2.5 (矽塔AG)', file = 'AG_Kimi-K2.5.json' },
        { key = 'c3', name = 'GLM-5 (矽塔)', file = 'Antchat_ST_GLM-5_GLM-5.json' },
        { key = 'c4', name = 'MiniMax 2.5 (MiniMax)', file = 'Minimax_MiniMax-M2.5.json' },
